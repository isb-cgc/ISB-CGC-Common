...
def cohort_manifest(cohort, user, fields, limit):
    try:
        ...
        cohort_records = get_collex_metadata(filters, fields, limit, sources=sources, versions=versions, counts_only=False, collapse_on='SOPInstanceUID', records_only=True)
