...
urlpatterns = [
    ...
    re_path(r'^copy_cohort/(?P<cohort_id>\d+)/',        views.copy_cohort, name='copy_cohort'),
    ...
    re_path(r'^download_ids/(?P<cohort_id>\d+)/$',       views.case_ids_by_cohort_filter, name='download_ids'),
    re_path(r'^download_ids_nologin/$',      views.case_ids_byfilter_nologin, name='download_ids_nologin'),
    re_path(r'^download_filelist/(?P<cohort_id>\d+)/',  views.streaming_csv_view, name='download_cohort_filelist'),
    re_path(r'^cohort_filter_stats/(?P<cohort_id>\d+)/$',      views.get_stats_from_cohort_filter, name='filter_stats'),
