...
def cohort_detail(request, cohort_id):
    ...
    try:
        ...
        template_values = build_explorer_context(is_dicofdic, source, versions, filters, fields, order_docs, counts_only, with_related, with_derived, collapse_on, is_json)
