...
class OneDatasetTestCase(TestCase):
    def setUp(self):
        test_csv_data_1 = [
            ...
            ['Second User', 'SECONDUSR', 'eRA', 'PI', 'seconduser@fake.com', '555-555-5555', 'active', 'phs000123.v1.p1.c1',
             'General Research Use', '2013-01-01 12:34:56.789', '2014-06-01 16:00:00.100', '2017-06-11 00:00:00.000', '']
        ]
    ...
    def test_one_line(self):
        ...
        NIHDatasetAdder(self.whitelist_1, DATABASE_ALIAS, dataset_acl_mapping).process_whitelist()
    ...
    def test_two_lines(self):
        """
        Test that two dataset IDs in a authorization list result in an AuthorizedDataset object being created
        for each.
        """
        test_dataset_mapping = {
            'phs000123': {
        ...
        NIHDatasetAdder(self.whitelist_2, DATABASE_ALIAS, dataset_acl_mapping).process_whitelist()
